...
class BookDetail extends Component {
  ...
  fetch_details() {
    const that = this;
    axios
      .get("/api/viewbook/" + this.props.match.params.id)
  ...
  render() {
    ...
    if (this.state.loaded) {
      if (!this.book) return <Redirect to="/books" />;
      content = (
        <div className="detail-container">
          ...
          <div className="book-detail">
            ...
            <div>
              by <span className="auth-name">{this.book.author}</span>
            </div>
    ...
    return (
      <div className="component-container">
        ...
        <div className="container">
          <div className="content-heading">Books / Details</div>
